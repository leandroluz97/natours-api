...
if (loginForm) loginForm.addEventListener("submit", (event)=>{
    ...
    (0, _login.login)({
        ...
        (0, _alerts.showAlert)("success", "Yor are LoggedIn");
        setTimeout(()=>{
            location.assign("/");
        }, 1500);
    }).catch((error)=>{
...
async function login({ email , password  }) {
    if (!email || !password) throw new Error("You should provied a email or password.");
    if (email.trim() === "" || password.trim() === "") throw new Error("Your email or password should not be empty.");
    const response = await (0, _axiosDefault.default).post("http://localhost:3000/api/v1/users/login", {
        email,
        password
    });
    return response;
...
},{"./../utils.js":"5By4s","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"1ftRF":[function(require,module,exports) {
/*eslint-disable */ var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"axios":"jo6P5","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"3zDlz":[function(require,module,exports) {
/*eslint-disable */ var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "displayMap", ()=>displayMap);
const displayMap = (locations)=>{
    mapboxgl.accessToken = "pk.eyJ1IjoibGVhbmRyb2x1ejk3IiwiYSI6ImNsYXg1dnExejBqYWEzcXFteWVyeHQ0MjEifQ.UJaeXfjKlcxnDcoH-Y3knw";
